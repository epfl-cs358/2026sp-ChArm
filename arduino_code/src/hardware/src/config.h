...
// Gear ratios
const int   DRIVING_TEETH  = 100; // TODO: recheck
const int   JOINT_TEETH = 105;
const int   BASE_TEETH = 160;

const float GEAR_RATIO_J1 = (float)DRIVING_TEETH / JOINT_TEETH;
const float GEAR_RATIO_J2 = (float)DRIVING_TEETH / JOINT_TEETH;
const float GEAR_RATIO_Z = (float)DRIVING_TEETH / BASE_TEETH;
