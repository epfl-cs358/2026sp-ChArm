...
class ArduinoUIControllerLink:
    ...
    def set_handlers(
        ...
        # This avoids accidentally removing the on_line set in __init__.
    ...
    def start(self) -> None:
        ...
        print("[UI DEBUG] Starting Arduino UI reader thread", flush=True)
    ...
    def close(self) -> None:
        print("[UI DEBUG] Closing Arduino UI serial link", flush=True)
    ...
    def send(self, command: str) -> None:
        """Send one newline-terminated command to Arduino."""
        print(f"[PY -> Arduino] {command}", flush=True)
    ...
    def _reader_loop(self) -> None:
        while not self._stop_event.is_set():
            try:
                ...
                print(f"[UI DEBUG] Serial read error: {e}", flush=True)
                break
    ...
    def _handle_line(self, line: str) -> None:
        print(f"[Arduino -> PY] {line}", flush=True)
        ...
        print(f"[UI DEBUG] Unknown Arduino line ignored: {line}", flush=True)
    ...
    def _handle_set_color(self, line: str) -> None:
        ...
        # Important: acknowledge color selection if Arduino waits for OK.
        self.send("OK")